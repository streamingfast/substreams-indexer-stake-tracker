    ...
    pub mod functions {
        ...
        pub struct Gateway {}
        impl Gateway {
            const METHOD_ID: [u8; 4] = [17u8, 97u8, 145u8, 182u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for Gateway {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Gateway {
        ...
        impl SetGateway {
            const METHOD_ID: [u8; 4] = [144u8, 100u8, 107u8, 74u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[ethabi::Token::Address(ethabi::Address::from_slice(&self.gw))],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
                encoded.extend(Self::METHOD_ID);
                encoded.extend(data);
        ...
        impl substreams_ethereum::Function for SetGateway {
            const NAME: &'static str = "setGateway";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetL1Address {
            pub addr: Vec<u8>,
        }
        impl SetL1Address {
            const METHOD_ID: [u8; 4] = [202u8, 82u8, 215u8, 215u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetL1Address {
            const NAME: &'static str = "setL1Address";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for BridgeBurned {
            const NAME: &'static str = "BridgeBurned";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for BridgeMinted {
            const NAME: &'static str = "BridgeMinted";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for GatewaySet {
            const NAME: &'static str = "GatewaySet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        impl substreams_ethereum::Event for L1AddressSet {
            const NAME: &'static str = "L1AddressSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
