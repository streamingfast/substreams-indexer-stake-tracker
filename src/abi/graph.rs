    ...
    pub mod functions {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct GetAllocation {
            pub allocation_id: Vec<u8>,
        }
        impl GetAllocation {
            const METHOD_ID: [u8; 4] = [14u8, 2u8, 41u8, 35u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for GetAllocation {
            const NAME: &'static str = "getAllocation";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        pub struct Initialize {
            ...
            pub rebates_parameters: (
                substreams::scalar::BigInt,
                substreams::scalar::BigInt,
                substreams::scalar::BigInt,
                substreams::scalar::BigInt,
            ),
            pub extension_impl: Vec<u8>,
        }
        impl Initialize {
            const METHOD_ID: [u8; 4] = [104u8, 127u8, 228u8, 14u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.minimum_indexer_stake.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.thawing_period.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.protocol_percentage.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.curation_percentage.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.max_allocation_epochs.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.delegation_unbonding_period.clone().to_bytes_be()
                                {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.delegation_ratio.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Tuple(
                            vec![
                                ...
                                .rebates_parameters.0.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .rebates_parameters.1.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .rebates_parameters.2.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                                .as_slice(),),),
                                ethabi::Token::Uint(ethabi::Uint::from_big_endian(match self
                                .rebates_parameters.3.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                panic!("negative numbers are not supported") }, }
                        ...
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.extension_impl),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetCounterpartStakingAddress {
            pub counterpart: Vec<u8>,
        }
        impl SetCounterpartStakingAddress {
            const METHOD_ID: [u8; 4] = [26u8, 231u8, 32u8, 69u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Address(
                            ethabi::Address::from_slice(&self.counterpart),
                        ),
                    ],
                );
                let mut encoded = Vec::with_capacity(4 + data.len());
        ...
        impl substreams_ethereum::Function for SetCounterpartStakingAddress {
            const NAME: &'static str = "setCounterpartStakingAddress";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.indexing_reward_cut.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.query_fee_cut.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.cooldown_blocks.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetExtensionImpl {
            pub extension_impl: Vec<u8>,
        }
        impl SetExtensionImpl {
            const METHOD_ID: [u8; 4] = [105u8, 72u8, 167u8, 140u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for SetExtensionImpl {
            const NAME: &'static str = "setExtensionImpl";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct SetRebateParameters {
            pub alpha_numerator: substreams::scalar::BigInt,
            pub alpha_denominator: substreams::scalar::BigInt,
            pub lambda_numerator: substreams::scalar::BigInt,
            pub lambda_denominator: substreams::scalar::BigInt,
        }
        impl SetRebateParameters {
            const METHOD_ID: [u8; 4] = [105u8, 40u8, 110u8, 71u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
            ...
            pub fn encode(&self) -> Vec<u8> {
                let data = ethabi::encode(
                    &[
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.alpha_numerator.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.alpha_denominator.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.lambda_numerator.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
                        ...
                        ethabi::Token::Uint(
                            ethabi::Uint::from_big_endian(
                                match self.lambda_denominator.clone().to_bytes_be() {
                                    (num_bigint::Sign::Plus, bytes) => bytes,
                                    (num_bigint::Sign::NoSign, bytes) => bytes,
                                    (num_bigint::Sign::Minus, _) => {
                                        panic!("negative numbers are not supported")
        ...
        impl substreams_ethereum::Function for SetRebateParameters {
            const NAME: &'static str = "setRebateParameters";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
    ...
    pub mod events {
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct ExtensionImplementationSet {
            pub extension_impl: Vec<u8>,
        }
        impl ExtensionImplementationSet {
            const TOPIC_ID: [u8; 32] = [
                12u8,
                183u8,
                171u8,
            ...
            pub fn decode(
                ...
                Ok(Self {
                    extension_impl: ethabi::decode(
                            &[ethabi::ParamType::Address],
                            log.topics[1usize].as_ref(),
                        )
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'extension_impl' from topic of type 'address': {:?}",
                                e
                            )
                        })?
                        .pop()
        ...
        impl substreams_ethereum::Event for ExtensionImplementationSet {
            const NAME: &'static str = "ExtensionImplementationSet";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        pub struct RebateCollected {
            ...
            pub epoch: substreams::scalar::BigInt,
            pub tokens: substreams::scalar::BigInt,
            pub protocol_tax: substreams::scalar::BigInt,
            pub curation_fees: substreams::scalar::BigInt,
            pub query_fees: substreams::scalar::BigInt,
            pub query_rebates: substreams::scalar::BigInt,
            pub delegation_rewards: substreams::scalar::BigInt,
        }
        impl RebateCollected {
            const TOPIC_ID: [u8; 32] = [
                245u8,
                222u8,
                208u8,
        ...
        impl substreams_ethereum::Event for RebateCollected {
            const NAME: &'static str = "RebateCollected";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct TransferredDelegationReturnedToDelegator {
            pub indexer: Vec<u8>,
            pub delegator: Vec<u8>,
            pub amount: substreams::scalar::BigInt,
        }
        impl TransferredDelegationReturnedToDelegator {
            const TOPIC_ID: [u8; 32] = [
                9u8,
                33u8,
                235u8,
        ...
        impl substreams_ethereum::Event for TransferredDelegationReturnedToDelegator {
            const NAME: &'static str = "TransferredDelegationReturnedToDelegator";
            fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
                Self::match_log(log)
            }
            fn decode(
